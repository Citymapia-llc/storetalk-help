...
If the app has its own management interface (for example, a store admin panel), an **Open Dashboard** button appears at the top of this tab.
...
A full log of every HTTP request and response between StoreTalk and the app, in both directions. Expand any row to see the exact request payload and the app's response. Use this tab when debugging unexpected behaviour.

### Orders

All orders placed through this app instance, including status and value. This tab only appears for apps that process orders.
